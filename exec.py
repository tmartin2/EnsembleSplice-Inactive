...
def main():
    ...
    if args.tune:
        assert len(args.all_esplice+args.esplice_d+args.esplice_l+args.esplice_p+args.esplice_s)==0,'EnsembleSplice cannot currently be tuned.'
    sub_models = [
    ...
    if type(args.all_esplice)==str:
        ...
        esplice_archs = ['esplice_d','esplice_l','esplice_p','esplice_s']
    # splice site asserts
